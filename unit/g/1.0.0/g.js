...
; (function (exports) {
    ...
    var conf = {
        ...
        loginfrm: $('<iframe id="loginFrame" scrolling="no"  frameborder="0" style="z-index:2; width:892px;height:605px; position:fixed;   background-color:transparent; " allowTransparency="true"></iframe>'),
        zIndex: 10000,
        show: function (userName) {
            ...
            conf.loginfrm = $('<iframe scrolling="no"  frameborder="0" style="z-index:2; width:892px;height:605px; position:fixed;   background-color:transparent; " allowTransparency="true"></iframe>');
        ...
        login_open: function (userName) {
            ...
            conf.loginfrm = $('<iframe id="loginFrame" scrolling="no"  frameborder="0" style="z-index:2; width:892px;height:605px; position:fixed;   background-color:transparent; " allowTransparency="true"></iframe>');
            $('body').append(conf.loginfrm);
            //console.log(conf);
            ...
            var callback = window.setInterval(function() {
                ...
                try{
                    ...
                    if( (ifr.src == 'http://www'+gomeplusDomain+'/glogin_callback.html') || (ifr.src =='https://www'+gomeplusDomain+'/glogin_callback.html') ) {
                        //alert(ifr.src);
...
; (function (exports) {
    ...
    function addCart(data, extend) {
        ...
        setTimeout(function () {
            g.ajax("//bigd"+gomeplusDomain+"/gome/dataOrderAssociate", {
                'pid': data.productId,
                area: g.cityCode(),
                'size': 4,
                'imagesize': 80,
