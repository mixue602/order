  ...
  watch: {
    ...
    select1: {
      handler (Type) {
        ...
        // if (parseInt(Type.type) === 1 && (this.select1.value1 === '' || this.select1.value2 === '')) {
        //   this.smalldata = true
        // } else {
...
.qujian_input .el-date-editor.el-input .el-input__inner{ background: #fff !important;}
.el-select-dropdown__item{padding: 0 10px !important;}
</style>
