...
<div v-if="!error"  class="order_detailsbox">
    <div class="order_details_l">
                    ...
                    <div class="el-table__body-wrapper is-scrolling-none">
                        <table cellspacing="0" cellpadding="0" border="0" class="el-table__header"   style="width: 100%;">
                            <thead class="has-gutter">
                                <tr class="">
                                    <th colspan="1" rowspan="1" class="el-table_2_column_4  is-center   is-leaf" width="320">
                                        <div class="cell">商品名称</div>
                                    </th>
                                    <th colspan="1" rowspan="1" class="el-table_2_column_5  is-center   is-leaf">
                                        <div class="cell">商品编码</div>
                                    </th>
                                    <th colspan="1" rowspan="1" class="el-table_2_column_6  is-center   is-leaf" width="100">
                                        <div class="cell">价格</div>
                                    </th>
                                    <th colspan="1" rowspan="1" class="el-table_2_column_7  is-center   is-leaf" width="80">
                            ...
                            <tbody class="el-table__body" v-for="(list,index) in  orderDetail.skuList" :key="index">
                                <tr class="el-table__row">
                                    <td class="el-table_2_column_4 is-center productName">
                                        <div class="cell">{{list.skuName}}</div>
                                    </td>
        ...
        <div class="order_details_cont settlement">
            <div class="ml40" style="float:right;margin-right:40px;">
                ...
                <div v-if="orderDetail.guiderType==4 && orderDetail.balanceAmount!=0">
                ...
                <div v-if="orderDetail.guiderType==3">
   ...
   <div class="order_details_r">
        ...
        <div class="orderinfo" v-if="orderDetail.entryCode || orderDetail.remark">
            <div class="item">
                <div class="label" style="width:44px">备注：</div> 
                <div class="info-rcol" v-if="orderDetail.entryCode" style="word-wrap: break-word; word-break: break-all; padding-right:10px">入场券代码&nbsp;{{orderDetail.entryCode}}</div> 
            </div>
            <div class="item" v-if="orderDetail.remark">
                <span class="label">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> 
                <div class="info-rcol" style="word-wrap: break-word; word-break: break-all; padding-right:45px">{{orderDetail.remark}}</div> 
            </div>
        </div>
    </div> 
</div>
