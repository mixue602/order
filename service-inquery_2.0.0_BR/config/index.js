...
http://10.115.3.53:3058 pccartview
...
var pccartview = "http://10.115.3.53:3058";
var pcsgpview = "http://10.115.3.53:3057";
var visualorder = "http://10.115.0.132:3212";
var laigoaccess = 'http:10.112.178.156:6001';

if (argumentssargv && argumentssargv == '52') {
  pccartview = "http://10.115.3.52:3058";
}
...
if (argumentssargv && argumentssargv == 'gome') {
  ...
  pccartview = "http://10.58.162.137:3083";
  pcsgpview = "http://10.58.162.136:3083";
...
if (argumentssargv && argumentssargv == '4344') {
  ...
  pccartview = "http://10.58.162.177:3082";

  pcsgpview = "http://10.115.80.84:3083";
  ...
  dev: {
    ...
    proxyTable: {
      ...
      "/visualorder": {
        ...
        secure: false,
        pathRewrite: {
          '^/visualorder': 'visual-order-web' //需要rewrite重写
        }
      },
      "/laigoaccess": {
        target: "http://10.112.178.156:6001",
        changeOrigin: true,
        secure: false
      }
