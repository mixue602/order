...
package org.gome.search.hotload.restart.classloader;
...
public class ClassLoaderFiles implements ClassLoaderFileRepository, Serializable {
	...
	/**
	 * Get or create a {@link ClassLoaderFiles.SourceFolder} with the given name.
	 * @param name the name of the folder
	 * @return an existing or newly added {@link ClassLoaderFiles.SourceFolder}
	 */
	...
	/**
	 * Return all {@link ClassLoaderFiles.SourceFolder SourceFolders} that have been added to the
	 * collection.
	 * @return a collection of {@link ClassLoaderFiles.SourceFolder} items
	 */
