...
import org.gome.search.hotload.restart.FailureHandler;
import org.gome.search.hotload.restart.Restarter;
import org.gome.search.hotload.classpath.ClassPathFolders;
import org.gome.search.hotload.filewatch.FileSystemWatcher;

/**
 * {@link org.gome.search.hotload.restart.FailureHandler} that waits for filesystem changes before retrying.
 *
 */
