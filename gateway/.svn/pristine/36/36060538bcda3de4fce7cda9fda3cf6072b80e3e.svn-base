...
package org.gome.search.hotload.restart;

import org.gome.search.hotload.restart.classloader.ClassLoaderFiles;
import org.gome.search.hotload.restart.classloader.RestartClassLoader;
...
public class Restarter {
	...
	/**
	 * Add additional {@link org.gome.search.hotload.restart.classloader.ClassLoaderFiles} to be included in the next restart.
	...
	/**
	 * Return a {@link java.util.concurrent.ThreadFactory} that can be used to create leak safe threads.
	...
	/**
	 * Thread that is created early so not to retain the {@link org.gome.search.hotload.restart.classloader.RestartClassLoader}.
	 */
	...
	/**
	 * {@link java.util.concurrent.ThreadFactory} that creates a leak safe thread.
	 */
