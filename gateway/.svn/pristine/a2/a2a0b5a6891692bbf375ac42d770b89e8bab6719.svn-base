package org.gome.search.ssdb.sharding;

import org.gome.search.ssdb.SsdbClientException;
import org.gome.search.ssdb.SsdbException;
import org.gome.search.ssdb.SsdbNoClusterAvailableException;
import org.gome.search.ssdb.conf.Cluster;
import org.gome.search.ssdb.conf.SPOFStrategy;
import org.gome.search.ssdb.conf.Sharding;
import org.gome.search.ssdb.util.MD5;
import org.gome.search.ssdb.util.Range;
...
public class ConsistentHashSharding extends Sharding {
    ...
    /**
     * 单点故障处理策略，参考 {@link org.gome.search.ssdb.conf.SPOFStrategy}
     */
