...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(pageData.isResult){
	    __webpack_require__(35);//右侧店铺精选和底部的推广商品
	    __webpack_require__(36).getData("#prdRight-2");//右侧热销推荐
	    __webpack_require__(37).getData("#prdRight-3");//右侧搜索了还购买了
	    //2017.12.8 与广告li确认去掉此推荐活动位require("./scripts/about/bigdata/search/dsp.activity").getData("#prdRight-4");//右侧底部推荐活动（图片）
	}else{
	    __webpack_require__(38).getData("#prdBottom-1");//无结果情况底部热销推荐
	}
	//底部延迟触发请求
	document.getElementById("lazyajaxloadarea").onmouseover = function (event) {
	    this.style.display = "none";
	    __webpack_require__(39).getData("#prdBottom-2");//猜你喜欢
